        ...
        <section className="locationSection">
          <div className="locationCard">
            <div>
              ...
              <p>
                1172 Đoàn Nguyễn Tuấn, Ấp 30, Xã Bình Chánh, TPHCM
              </p>
              <a
                href="https://www.google.com/maps/search/?api=1&query=10.662054,106.601158"
                target="_blank"
                rel="noreferrer"
        ...
        <footer className="footer">
          <div className="footerGrid">
            ...
            <div className="footerCol">
              ...
              <p>☎ 028 3760 8573 - 03 3206 3203</p>
              <p>✉ mnbongsenhong@gmail.com</p>
              <p>📍 1172 Đoàn Nguyễn Tuấn, Ấp 30, Xã Bình Chánh, TPHCM</p>
            </div>
